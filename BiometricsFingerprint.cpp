...
#define LOG_TAG "android.hardware.biometrics.fingerprint@2.3-service.lge_kona"
...
BiometricsFingerprint::BiometricsFingerprint(): mClientCallback(nullptr), mDevice(nullptr) {
    ...
    if (!mDevice) {
        ...
        SetProperty("persist.vendor.sys.fp.vendor", "kona");
...
IBiometricsFingerprint* BiometricsFingerprint::getInstance() {
    if (!sInstance) {
        ALOGD("New Instance being generated");
